...
class Product(models.Model):
    unique_id=models.CharField(max_length=100,default='',null=False,unique=True, blank=False)
    name=models.CharField(max_length=100,default='',null=False,unique=True, blank=False)
...
class Batch(models.Model):
    ...
    fee_prog=models.ForeignKey(FeeProgram,on_delete=models.SET_NULL,null=True)
    date=models.DateField(auto_now=True)
